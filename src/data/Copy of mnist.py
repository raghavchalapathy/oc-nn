...
class MNIST_DataLoader(DataLoader):
    ...
    def __init__(self):
        ...
        self.modelsave_path = "/content/drive/My Drive/2018/Colab_Deep_Learning/one_class_neural_networks//models/MNIST/DCAE/"
    ...
    def load_data(self, original_scale=False):
        ...
        if Cfg.ad_experiment:
            ...
            # self._X_train = np.concatenate((self._X_train,X_norm))
    ...
    #     autoencoder.compile(optimizer=adam,
        #                              loss=MNIST_DataLoader.custom_rcae_loss(self, self.mue, self.lamda, U, V, N))
    #
